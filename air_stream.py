...
st.set_page_config(page_icon="airbnb.ico",page_title = 'AirBNB',layout='wide')

st.markdown('<b><h1 style="text-align: center;color: ##ACC8E5;">AirBNB EDA with Python & PowerBI</h1>', unsafe_allow_html=True)
st.divider()
...
<style>
    [data-testid=stSidebar] {
        background-color: #02153D;  /* Sidebar background color */
    }
    .mainMenu {
...
set_background(r'C:\Users\jesik\OneDrive\Desktop\Project-4-AirBNB\BG.jpeg')

df1 = pd.read_csv('JesiAirBNB.csv')

menu = st.selectbox("Main Menu", ["Home", 'Sample Data', 'Analysis and Insights', 'Folium Maps', 'PowerBI Dashboard'],
                    index=0)
if menu == "Home":
    st.subheader("What is Airbnb Data?",divider='green')
    with st.container():
        ...
        with col2:
            ...
            st.markdown("<h4 style='text-align: left; color: #aedcad;'>What are the attributes of AirBnB Data? </h4>", unsafe_allow_html=True)
            st.write("There are many different aspects to AirBnB data from both the consumer and host side of the operation.")
            st.markdown("<h5 style='text-align: left; color: #aedcad;'>Consumer-side data: </h5>", unsafe_allow_html=True)
            ...
            st.markdown("<h5 style='text-align: left; color: #aedcad;'>Host-side data: </h5>", unsafe_allow_html=True)
